...
export function initSpecies() {
    ...
    new PokemonSpecies(Species.FOGGY, 9, false, false, true, "Thundercloud Pokémon", Type.ELECTRIC, Type.FLYING, 0.3, 0.3, Abilities.DRIZZLE, Abilities.NONE, Abilities.NONE, 516, 60, 60, 60, 131, 100, 105, 3, 0, 300, GrowthRate.MEDIUM_FAST, null, false),
